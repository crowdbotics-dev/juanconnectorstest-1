"""
Django settings for juanconnectorstest_1 project.
...
ROOT_URLCONF = 'juanconnectorstest_1.urls'
...
WSGI_APPLICATION = 'juanconnectorstest_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanconnectorstest_1 API",
    "DESCRIPTION": "API documentation for juanconnectorstest_1 App",
    "VERSION": "v1",
}
