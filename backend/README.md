...
## Project Structure
    ...
    ├── juanconnectorstest_1  # Django project configurations
...
1. Clone this repo and `cd juanconnectorstest_1`
...
2. Clone this repo and `cd juanconnectorstest_1`
